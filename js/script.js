...
function addTodo() {
  ...
  const timesclock = document.getElementById("time").value;
...
/* 
  ...
  */
function generateTodoObject(id, task, timestamp, timesclock, isCompleted) {
  return {
    id,
    task,
    timestamp,
...
function makeTodo(todoObject) {
  ...
  const textTimeclock = document.createElement("p");
  textTimeclock.innerText = todoObject.timesclock;

  const textContainer = document.createElement("div");
  textContainer.classList.add("inner");
  textContainer.append(textTitle, textTimestamp, textTimeclock);
